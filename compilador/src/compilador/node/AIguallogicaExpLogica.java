...
public final class AIguallogicaExpLogica extends PExpLogica
{
    private PExpLogica _left_;
    private PExpLogica _right_;

    public AIguallogicaExpLogica()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AIguallogicaExpLogica(
    ...
    {
        ((Analysis) sw).caseAIguallogicaExpLogica(this);
    }
