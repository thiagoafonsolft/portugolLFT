...
public final class ADeclaracaoDeclaracaoLista extends PDeclaracaoLista
{
    private PDeclaracao _declaracao_;

    public ADeclaracaoDeclaracaoLista()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new ADeclaracaoDeclaracaoLista(
    ...
    {
        ((Analysis) sw).caseADeclaracaoDeclaracaoLista(this);
    }
