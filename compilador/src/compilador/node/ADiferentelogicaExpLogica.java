...
public final class ADiferentelogicaExpLogica extends PExpLogica
{
    private PExpLogica _left_;
    private PExpLogica _right_;

    public ADiferentelogicaExpLogica()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new ADiferentelogicaExpLogica(
    ...
    {
        ((Analysis) sw).caseADiferentelogicaExpLogica(this);
    }
